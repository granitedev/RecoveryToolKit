...
class CompassionQ5Fragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): CompassionQ5Fragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = CompassionQ5Fragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_compassion_q5, container, false)
    }
