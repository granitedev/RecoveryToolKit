...
class YawningFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): YawningFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = YawningFragment()
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        rg9.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(YawningFragment.RADIO_KEY)
    ...
    val layoutResId: Int
        get() = arguments.getInt(YawningFragment.LAYOUT_RESOURCE_ID_ARG_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(YawningFragment.RADIO_KEY, RadioGroup)
