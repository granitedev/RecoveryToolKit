...
import com.granitemountainbhc.recoverytoolkit.fragments.scales.step.shame.ShameQuestion1Fragment
import com.stepstone.stepper.BlockingStep
import com.stepstone.stepper.StepperLayout
import com.stepstone.stepper.VerificationError


class CompassionQ2Fragment : Fragment(), BlockingStep {
        ...
        companion object {
            ...
            fun newInstance(@LayoutRes layoutResId: Int): CompassionQ2Fragment {
                val args = Bundle()
                args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
                val fragment = CompassionQ2Fragment()
        ...
        override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            ...
            return inflater!!.inflate(R.layout.fragment_compassion_q2, container, false)
        }
