...
class RunnyFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): RunnyFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = RunnyFragment()
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        rg6.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(RunnyFragment.RADIO_KEY)
    ...
    val layoutResId: Int
        get() = arguments.getInt(RunnyFragment.LAYOUT_RESOURCE_ID_ARG_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(RunnyFragment.RADIO_KEY, RadioGroup)
