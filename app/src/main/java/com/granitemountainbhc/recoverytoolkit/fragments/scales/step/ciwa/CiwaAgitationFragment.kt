...
class CiwaAgitationFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): CiwaAgitationFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = CiwaAgitationFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_ciwa_agitation, container, false)
    }
    @Suppress("DEPRECATION")
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val rg10 = view!!.findViewById<View>(R.id.ciwaAgitationGroup) as RadioGroup
        rg10.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(CiwaAgitationFragment.RADIO_KEY)
    ...
    val layoutResId: Int
        get() = arguments.getInt(CiwaAgitationFragment.LAYOUT_RESOURCE_ID_ARG_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(CiwaAgitationFragment.RADIO_KEY, RadioGroup)
