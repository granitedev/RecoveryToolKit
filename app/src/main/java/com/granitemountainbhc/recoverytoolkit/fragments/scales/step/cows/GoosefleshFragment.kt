...
class GoosefleshFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): GoosefleshFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = GoosefleshFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_cows_gooseflesh, container, false)
    }

    @Suppress("DEPRECATION")
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val rg11 = view!!.findViewById<View>(R.id.goosefleshGroup) as RadioGroup
        rg11.setOnCheckedChangeListener { _, checkedId ->
            val context = context
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(GoosefleshFragment.RADIO_KEY)
    ...
    val layoutResId: Int
        get() = arguments.getInt(GoosefleshFragment.LAYOUT_RESOURCE_ID_ARG_KEY)

    override fun verifyStep(): VerificationError? {
        val rg11 = view!!.findViewById<View>(R.id.goosefleshGroup) as RadioGroup
        return if (rg11.getCheckedRadioButtonId() == -1) VerificationError("Please select an answer!") else null
    }
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(GoosefleshFragment.RADIO_KEY, RadioGroup)
