...
class CiwaSweatsFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): CiwaSweatsFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = CiwaSweatsFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_ciwa_sweats, container, false)
    }
    @Suppress("DEPRECATION")
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val rg10 = view!!.findViewById<View>(R.id.ciwaSweatsGroup) as RadioGroup
    ...
    val layoutResId: Int
        get() = arguments.getInt(CiwaSweatsFragment.LAYOUT_RESOURCE_ID_ARG_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(CiwaSweatsFragment.RADIO_KEY, RadioGroup)
