...
class LimitsQuestion1Fragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): LimitsQuestion1Fragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = LimitsQuestion1Fragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_limits_question1, container, false)
    }

    @Suppress("DEPRECATION")
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val rg1 = view!!.findViewById<View>(R.id.menGroup) as RadioGroup
        ...
        val rg2 = view!!.findViewById<View>(R.id.womenGroup) as RadioGroup
...
//TODO Make so where either a men group option or women group option has to be selected
    val layoutResId: Int
