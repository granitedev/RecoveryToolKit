...
class CiwaAuditoryFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): CiwaAuditoryFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = CiwaAuditoryFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater!!.inflate(R.layout.fragment_ciwa_auditory, container, false)
    }
    @Suppress("DEPRECATION")
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val rg10 = view!!.findViewById<View>(R.id.ciwaAuditoryGroup) as RadioGroup
        rg10.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(CiwaAuditoryFragment.RADIO_KEY)
    ...
    val layoutResId: Int
        get() = arguments.getInt(CiwaAuditoryFragment.LAYOUT_RESOURCE_ID_ARG_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(CiwaAuditoryFragment.RADIO_KEY, RadioGroup)
