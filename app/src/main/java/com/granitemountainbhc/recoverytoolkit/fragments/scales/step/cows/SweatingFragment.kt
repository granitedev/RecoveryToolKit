...
class SweatingFragment : Fragment(), BlockingStep {
    ...
    companion object {
        ...
        fun newInstance(@LayoutRes layoutResId: Int): SweatingFragment {
            val args = Bundle()
            args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId)
            val fragment = SweatingFragment()
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        rg2.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (savedInstanceState != null) {
                RadioGroup = savedInstanceState.getInt(SweatingFragment.RADIO_KEY)
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        outState!!.putInt(SweatingFragment.RADIO_KEY, RadioGroup)
