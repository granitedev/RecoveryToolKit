...
import com.granitemountainbhc.recoverytoolkit.adapter.step.LimitsStepperAdapter
import com.stepstone.stepper.StepperLayout
import com.stepstone.stepper.VerificationError

class LimitsActivity : AppCompatActivity(), StepperLayout.StepperListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val startingStepPosition = savedInstanceState?.getInt(LimitsActivity.CURRENT_STEP_POSITION_KEY) ?: 0
        stepperLayout.setAdapter(LimitsStepperAdapter(supportFragmentManager, this), startingStepPosition)

        stepperLayout.setListener(this)
    }
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putInt(LimitsActivity.CURRENT_STEP_POSITION_KEY, stepperLayout.currentStepPosition)
